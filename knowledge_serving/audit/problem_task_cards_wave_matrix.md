...
| 11 | W1 | KS-DIFY-ECS-001 | done | FAIL | Real staging mirror check exits 1 with ECS mirror drift. | Fix ECS mirror drift and rerun. |
...
| 21 | W1 | KS-DIFY-ECS-011 | done | FAIL | Dry-run is blocked by dirty `clean_output`; mirror push is not currently accepted. | Clean the worktree and run real mirror dry-run / apply path. |
